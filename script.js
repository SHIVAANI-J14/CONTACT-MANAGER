...
document.addEventListener('DOMContentLoaded', () => {
    ...
    searchBtn.addEventListener('click', () => {
        ...
        records.forEach(record => {
            const name = record.querySelector('#name-content').innerText.toLowerCase();
            const address = record.querySelector('#address-content').innerText.toLowerCase();
            const contactNum = record.querySelector('#contact-num-content').innerText.toLowerCase();
            
            if (name.includes(query) || address.includes(query) || contactNum.includes(query)) {
    ...
    recordContainer.addEventListener('click', (e) => {
        if (e.target.closest('#edit-btn')) {
            ...
            const name = recordItem.querySelector('#name-content').innerText;
            const address = recordItem.querySelector('#address-content').innerText;
            const contactNum = recordItem.querySelector('#contact-num-content').innerText;
            
            document.getElementById('name').value = name;
            document.getElementById('address').value = address;
            document.getElementById('contact-num').value = contactNum;
